...
export default function ProductData9() {
  const featureBoxes = [
    {
      title: "Flexible",
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <ProductHero title={<>Esano ACA - Advanced Placental <br /> Tissue Allograft</>} bgImage={dataimg1} />
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-12 md:gap-20">
        ...
        <div className="md:w-1/2 flex justify-center md:justify-start">
          <p className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-semibold text-black leading-relaxed sm:text-center md:text-left ">
            Esano™ ACA is a dehydrated amnion/ chorion/amnion membrane sheet protective covering to aid in wound management.
          </p>
        </div>
