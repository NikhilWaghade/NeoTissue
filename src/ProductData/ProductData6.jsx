...
export default function ProductData6() {
  const featureBoxes = [
    ...
    { title: "Full Thickness", img: "https://cdn.prod.website-files.com/65dd69e5c5c0b3458916abfc/6764373d7f4cc78078d430bc_Frame%20(1).svg" },
    ...
    <div className="w-full">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-12">
        ...
        <div className="md:w-1/2">
          <p className="text-xl md:text-5xl text-black leading-snug">
        ...
        <div className="md:w-1/2 flex flex-col items-center md:items-start">
          <img
            src={productImg3}
            alt="Activate Product"
            className="rounded-xl shadow-lg mb-6 w-full max-w-lg"
          />
          <p className="text-sm md:text-lg text-black text-center md:text-left">
            Activate™ is a full thickness placental-derived allograft composed
            of: Amnion Intermediate Chorion layers. These layers are processed
            to cleanse and decellularize the tissue while preserving essential
