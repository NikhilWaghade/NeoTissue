...
export default function ProductData5() {
  const featureBoxes = [
    ...
    {
      title: "Lyophilized",
      img: "https://cdn.prod.website-files.com/65dd69e5c5c0b3458916abfc/67f663b691d6986906d1e01f_Frame%20(4).svg",
    },
    {
  ...
  return (
    <div className="w-full">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-12">
        {/* Left Side Text */}
