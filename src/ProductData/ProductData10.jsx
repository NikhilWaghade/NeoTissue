...
export default function ProductData10() {
  const featureBoxes = [
    {
      title: "Flexible",
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <ProductHero title={<>Membrane Wrap Hydro™</>} bgImage={dataimg1} />
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-12 md:gap-20">
        ...
        <div className="md:w-1/2 flex justify-center md:justify-start">
          <p className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-semibold text-black leading-relaxed sm:text-center md:text-left ">
            Membrane Wrap Hydro™ is a Pre-Hydrated Dual-Layer Amniotic Tissue
        ...
        <div className="md:w-1/2 flex flex-col items-start">
          ...
          <p className="text-base sm:text-lg md:text-xl text-black leading-relaxed text-left">
            Membrane Wrap-Hydro™ is a pre-hydrated dual-layered human tissue
            allograft derived from amniotic membrane that may serve as a barrier
            and protective covering for wounds. Through minimal manipulation,
            the allograft aims to maintain properties exhibited in its natural
            state. The tissue undergoes terminal sterilization and testing for
            potentially infectious diseases to support safety protocols, and is
            designed to be readily available for various applications.
          </p>
        </div>
      </section>
